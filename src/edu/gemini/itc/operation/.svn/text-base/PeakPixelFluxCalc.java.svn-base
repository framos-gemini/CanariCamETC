...
public class PeakPixelFluxCalc {
	...
	/**
	 * @uml.property  name="exp_time"
	 */
	private double exp_time;
    /**
	 * @uml.property  name="summed_source"
	 */
    private double summed_source;
	/**
	 * @uml.property  name="summed_background"
	 */
	private double summed_background;
	/**
