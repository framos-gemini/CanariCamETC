...
public final class ObservingConditionParameters extends ITCParameters {
    ...
    // Data members
    /**
	 * @uml.property  name="_imageQuality"
	 */
    private int _imageQuality;
    /**
	 * @uml.property  name="_skyTransCloud"
	 */
    private int _skyTransCloud;
    /**
	 * @uml.property  name="_skyTransWater"
	 */
    private int _skyTransWater;
    /**
	 * @uml.property  name="_skyBackground"
	 */
    private int _skyBackground;
    /**
	 * @uml.property  name="_airmass"
	 */
    ...
    public void parseServletRequest(HttpServletRequest r) throws Exception {
        ...
        _skyTransCloud = ITCParameters.parseInt(s, "Sky transparency (cloud cover)");
    ...
    public String getSkyBackgroundCategoryORM() {
        if (_skyBackground == 1)
            return "05p0";
        else if (_skyBackground == 2)
            return "07p0";
    ...
    public String getAirmassCategory() {
    	...
    	if (_airmass <= 1.0)
            return"10";
        else if (_airmass <= 1.1)
            return"11";
        else if (_airmass <= 1.5)
            return"15";
        else
        	return"20";
    }
