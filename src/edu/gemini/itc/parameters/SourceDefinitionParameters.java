...
public final class SourceDefinitionParameters extends ITCParameters
{
   ...
   // Data members
   /**
 * @uml.property  name="_sourceGeom"
 */
private String _sourceGeom;  // point or extended
   /**
 * @uml.property  name="_extSourceType"
 */
private String _extSourceType; // uniform, gaussian, ...
   /**
 * @uml.property  name="_sourceNorm"
 */
...
private double _redshift;  // z
   ...
   public void parseServletRequest(HttpServletRequest r) throws Exception
   {
	 ...
	 throw new Exception("Unrecognized source geometry: " +
      ...
      if (_normType.equals(FILTER)) {
    	  ...
    	  _normWavelength = ITCParameters.parseDouble(wavelen, "Normalization wavelength");
     } else {
   ...
   public void parseMultipartParameters(ITCMultiPartParser p) throws Exception {
        ...
        try {
            ...
            if (_sourceGeom.equals(POINT_SOURCE)) {
                ...
                if (getUnitCode(_units)<0) { throw new Exception("Unrecognized units: " + _units);}
            }else if (_sourceGeom.equals(EXTENDED_SOURCE)){
                ...
                if (_extSourceType.equals(GAUSSIAN)){
                    ...
                    if (getUnitCode(_units)<0) { throw new Exception("Unrecognized units: " + _units);}
                }else {throw new Exception("Unrecognized extended source geometry: " + _extSourceType);}
            }else { throw new Exception("Unrecognized source geometry: " + getSourceGeometry());}
            ...
            }else {throw new Exception("Unrecognized normalization type: " + getNormType()); }
            ...
            }else {throw new Exception("Unrecognized spectrum type: " + _sourceSpec);}
            ...
            } else {throw new Exception("Unrecognized redshift method: " + recession);}
   ...
   public String getSourceGeometry() { return _sourceGeom; }
   public String getExtendedSourceType() { return _extSourceType; }
   public double getSourceNormalization() { return _sourceNorm; }
   public String getUnits() { return _units; }
   public double getFWHM() {return _fwhm; }
   public String getNormType() { return _normType; }
   public String getNormBand() { return _normBand; }
   public double getNormWavelength() { return _normWavelength; }
   public double getRedshift() { return _redshift; }
   public String getSourceSpec() { return _sourceSpec;}
   public String getSpecType() {return _specType;}
   public String getSpectrumResource() { return _sedSpectrum; }
   public double getBBTemp() { return _bBTemp; }
   public double getELineWavelength() { return _eLineWavelength;}
   public double getELineWidth() { return _eLineWidth; }
   public double getELineFlux() { return _eLineFlux; }
   public double getELineContinuumFlux() { return _eLineContinuumFlux; }
   public String getELineFluxUnits() { return _eLineFluxUnits;}
   public String getELineContinuumFluxUnits(){ return _eLineContinuumFluxUnits;}
   
   public String getELineFluxUnitsCustom(){
	   switch (_eLineFluxUnits) {
	   	case WATTS_FLUX : 
		   return "W/m^2";
	   	case ERGS_FLUX: 
		   return "ergs/s/cm^2"; 
   ...
   public String getELineContFluxUnits(){
	   switch (_eLineContinuumFluxUnits) {
	   	case WATTS : 
		   return "W/m^2/um";
	   	case ERGS_WAVELENGTH: 
		   return "ergs/s/cm^2/A"; 
	   }
	   
	   return _eLineContinuumFluxUnits;
   }
   
   public double getPowerLawIndex(){return _pLawIndex;}
   public boolean isSedUserDefined() {return _isSEDUserDefined;}
   public String getUserDefinedSpectrum(){return _userDefinedSedString;}
