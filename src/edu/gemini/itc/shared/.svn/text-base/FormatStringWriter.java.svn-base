...
//
// $Id: FormatStringWriter.java,v 1.2 2003/11/21 14:31:02 shane Exp $
//
...
public class FormatStringWriter {
    ...
    /**
	 * @uml.property  name="_sJustifications" multiplicity="(0 -1)" dimension="1"
	 */
    ...
    /**
	 * @uml.property  name="_sBases" multiplicity="(0 -1)" dimension="1"
	 */
