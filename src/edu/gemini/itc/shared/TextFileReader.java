...
public class TextFileReader {
    ...
    /**
	 * @uml.property  name="_br"
	 */
    private BufferedReader _br = null;

    /**
	 * @uml.property  name="_currentLine"
	 */
    private String _currentLine = null;
    /**
	 * @uml.property  name="_currentLineNumber"
	 */
    private int _currentLineNumber = 0;

    /**
	 * @uml.property  name="_lookaheadLine"
	 */
    private String _lookaheadLine = null;
    /**
	 * @uml.property  name="_lookaheadLineNumber"
	 */
    private int _lookaheadLineNumber = 0;

    /**
	 * @uml.property  name="_st"
	 */
